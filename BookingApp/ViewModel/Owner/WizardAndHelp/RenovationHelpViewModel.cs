...
{
    public class RenovationHelpViewModel : ViewModel
    {
        ...
        public RenovationHelpViewModel(UserDTO loggedInUser)
        {
            _images = new List<string>();
            _loggedInUser = loggedInUser;

            _images.Add("../../../Resources/Images/WizardAndHelp/RenovationHelp1.png");
            _images.Add("../../../Resources/Images/WizardAndHelp/RenovationHelp2.png");
            _images.Add("../../../Resources/Images/WizardAndHelp/RenovationHelp3.png");
            _images.Add("../../../Resources/Images/WizardAndHelp/RenovationHelp4.png");
        ...
        private void NextImage()
        {
            ...
            {
                OwnerMainWindow.MainFrame.Content = new RenovationsPage(_loggedInUser);
            }
        }
